...
After deployment is done, you should proceed with:

- `docs/DATA_INGESTION.md` (how SC/HC/Tribunal ingestion works)
- `docs/RAG_PIPELINE.md` (retrieval + reranking flow)
- `docs/MONITORING.md` (logging + evaluation + debugging setup)
